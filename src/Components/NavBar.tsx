...
function NavBar() {
    ...
    return(
        <div className="navbar">
            {/* Navbar content */}
            <img src="src/assets/bwh-logo.svg" className={"bwh-logo"} alt={"Brigham and Women's Hospital logo, reading " +
            ...
            <div className={"navButtons"}>
                ...
                <div className={"dropdown"}>
                    ...
                    <div className={"dropdown-content"}>
                        <ul>
                            <li>
                                <Link to={"/log-out"} className={"button"} id={"log-out"}>Log Out</Link>
                            </li>
                            <li>
